  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl overflow-x-auto w-full sm:w-auto">
          {(['today', 'week', 'month', 'annual', 'custom'] as StatsPeriod[]).map((p) => (
            <button
              key={p}
              onClick={() => setPeriod(p)}
              className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all flex-shrink-0 ${period === p
      ...
      <div className="space-y-6 relative">
        ...
        <section aria-labelledby="overview-title" className="space-y-6">
          <div>
            <h3 id="overview-title" className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wider">Visão Geral</h3>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center">
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Tempo Total</h3>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatStudyTime(totalStudyTime)}</p>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center">
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Revisões</h3>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{completedReviewsCount}</p>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center">
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Dias Estudados</h3>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{totalDatesStudied}</p>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center">
                <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Último Estudo</h3>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`text-sm font-bold ${isGoalCompleted ? 'text-green-600 dark:text-green-400' : 'text-primary-600 dark:text-primary-400'}`}>
                    {weeklyProgress}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-3 mb-2">
                  <div
                    className={`h-3 rounded-full transition-all duration-300 ${isGoalCompleted ? 'bg-green-500' : 'bg-primary-500'}`}
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <br />
                    <span className="text-xs text-primary-600 dark:text-primary-400">Atual: {formatStudyTime(weeklyStudyTime)}</span>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Progresso Hoje</span>
                    <span className="text-xs font-bold text-gray-700 dark:text-gray-300">{dynamicGoals.dailyProgress}%</span>
                  </div>
                  ...
                  <div className="flex justify-between text-xs">
                    <span className="text-primary-600 dark:text-primary-400">{formatStudyTime(dynamicGoals.todayTime)}</span>
                    <span className="text-gray-500 dark:text-gray-400">Meta: {formatStudyTime(dynamicGoals.dailyGoal)}</span>
                  </div>
                </div>
                <div className="p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Projeção Semanal</p>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col">
            <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wider">Flashcards</h3>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 h-80 flex flex-col">
              <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider flex items-center">
                📊 Comparativo Temporal
              </h3>
              <div className="grid grid-cols-2 gap-4 text-xs flex-1 content-center">
                <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="font-medium text-gray-600 dark:text-gray-400 mb-1">Esta Semana</p>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{formatStudyTime(temporalComparisons.weekComparison.current)}</p>
                  <p className={`text-xs ${temporalComparisons.weekComparison.current >= temporalComparisons.weekComparison.previous ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
                ...
                <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="font-medium text-gray-600 dark:text-gray-400 mb-1">Este Mês</p>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{formatStudyTime(temporalComparisons.monthComparison.current)}</p>
                  <p className={`text-xs ${temporalComparisons.monthComparison.current >= temporalComparisons.monthComparison.previous ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
                ...
                <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="font-medium text-gray-600 dark:text-gray-400 mb-1">Melhor Dia</p>
                  <p className="text-sm font-bold text-gray-900 dark:text-white">{temporalComparisons.bestDay.day}</p>
                  <p className="text-xs text-primary-600 dark:text-primary-400">{formatStudyTime(temporalComparisons.bestDay.avgTime)} média</p>
                </div>
                <div className="text-center p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                  <p className="font-medium text-gray-600 dark:text-gray-400 mb-1">Simulados</p>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">{temporalComparisons.simuladosComparison.current}</p>
                  <p className={`text-xs ${temporalComparisons.simuladosComparison.current >= temporalComparisons.simuladosComparison.previous ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
